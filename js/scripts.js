...
function compTurn() {
  ...
  console.log("Numbers generated by computer roll: " + diceRollResult);
  if (diceRollResult[0] === 1 || diceRollResult[1] === 1) {
    roundScore = 0;
    console.log('computer total score: ' + currentRoster.players[currentTurnID].score);
    turnSwap();
  } else {
    roundScore += diceRollResult[0] + diceRollResult[1]
    console.log('computer round score: ' + roundScore);
